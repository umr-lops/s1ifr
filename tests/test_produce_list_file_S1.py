...
class TestProduceListFileS1(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        produce_list_file_S1.ADDITIONAL_ARCHIVES = cls.mock_config['paths']['archives']
        produce_list_file_S1.sats_acro = cls.mock_config['satellites']['acronyms']
    ...
    def test_list_safe_s1_ifr_fs_success(self, mock_glob, mock_write_file):
        ...
        self.assertEqual(mock_glob.call_count, 2)  # Called once for each day in the range
