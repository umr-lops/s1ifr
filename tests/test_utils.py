...
class TestUtils(unittest.TestCase):
    ...
    def test_load_config_uses_local_if_exists(self, mock_exists, mock_file, mock_yaml_load):
        """
    ...
    @patch('s1ifr.utils.open', new_callable=mock_open)
    @patch('s1ifr.utils.os.path.exists')
    def test_load_config_falls_back_to_default(self, mock_exists, mock_file, mock_yaml_load):
        """
        ...
        mock_file.assert_called_once_with(expected_default_path, 'r')
        self.assertEqual(config, expected_config)
