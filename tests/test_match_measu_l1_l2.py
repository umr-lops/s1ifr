...
from s1ifr.match_measu_l1_l2 import (
    getNCcorresponding2TIFF,
    getTiffcorresponding2NetCDF,
)
...
L1_TIF_NAME = (
    "s1a-wv1-slc-vv-20150911t123908-20150911t123911-007667-00aa41-079.tiff"
)
...
def test_getTiffcorresponding2NetCDF_modern_exists(mock_explode_safe):
    ...
    with patch(
        "s1ifr.match_measu_l1_l2.getL1SAFEcorrespondingToL2SAFE",
        return_value=l1_safe_dir,
    ):
...
def test_getTiffcorresponding2NetCDF_pre_ipf_reindexing(mock_explode_safe):
    ...
    with patch(
        "s1ifr.match_measu_l1_l2.getlast_imagette_number_in_safe",
        return_value=100,
    ):
        with patch(
            "s1ifr.match_measu_l1_l2.get_l1_indice", return_value=85
        ):  # 079 maps to 085
            with patch(
                "s1ifr.match_measu_l1_l2.getL1SAFEcorrespondingToL2SAFE",
                return_value=l1_safe_dir,
