...
VALID_SAFE_NAME = (
    "S1A_IW_SLC__1SDV_20230101T120000_20230101T120025_012345_0AB123_4567.SAFE"
)
...
def test_add_L1B_success(mock_load_conf, mock_config, sample_df, mocker):
    ...
    mocker.patch(
        "s1ifr.paths_safe_product_family._resolve_slc_path",
...
def test_add_L2WAV_no_slc(sample_df, mocker):
    ...
    with patch(
        "s1ifr.paths_safe_product_family.load_config",
        return_value=mock_conf_data,
    ):
        mocker.patch(
            "s1ifr.paths_safe_product_family._resolve_slc_path",
            return_value=None,
